...
<template>
    <SidebarProvider>
        <Sidebar collapsible="icon"  class='dark:bg-zinc-950 dark:text-white'>
            <SidebarHeader>
                <SidebarMenu>
                    <SidebarMenuItem>
                        <DropdownMenu>
                    ...
                    <SidebarMenuItem>
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent class="w-[--radix-dropdown-menu-trigger-width] min-w-56 rounded-lg"
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuGroup>
                                    <DropdownMenuItem @click="router.visit('/profile', { method: 'get' })">
                                        <BadgeCheck />
                                        Profile
                                    </DropdownMenuItem>
                                    <DropdownMenuItem>
                        ...
                        <BreadcrumbList>
                            <template v-for="breadcrumb in breadcrumbs">
                                <BreadcrumbItem class="hidden md:block">
                                    <BreadcrumbPage v-if='breadcrumb.isCurrentPage'>{{ breadcrumb.label }}
                                    </BreadcrumbPage>

                                    <BreadcrumbLink v-else :href="breadcrumb.href">
                                        {{ breadcrumb.label }}
                                    </BreadcrumbLink>

                                </BreadcrumbItem>
                                <BreadcrumbSeparator v-if='!breadcrumb.isCurrentPage' class="hidden md:block" />
                            </template>
                        </BreadcrumbList>
                    </Breadcrumb>
                </div>
